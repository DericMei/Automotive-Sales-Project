...
@app.callback(
    ...
    [Input(component_id='input_year', component_property='value'), Input(component_id='dropdown-statistics', component_property='value')])
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        unemployment_vehicle = recession_data.groupby(['Vehicle_Type', 'unemployment_rate'])['Automobile_Sales'].mean().reset_index()                           
        R_chart4  = dcc.Graph(
            figure=px.bar(unemployment_vehicle, 
                x='Vehicle_Type',
                y='Automobile_Sales',
                title="Sales Across Vehicle Types over Recession Period"))
